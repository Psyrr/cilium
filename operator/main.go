...
func init() {
	...
	flags.DurationVar(&cnpStatusUpdateInterval, "cnp-status-update-interval", 10*time.Second, "interval between CNP status updates sent to the k8s-apiserver per-CNP")
